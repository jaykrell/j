...
#pragma warning(disable:4305) /* truncating conversion far pointer<>int -- need to use large model or size_t */
#pragma warning(disable:4306) /* truncating conversion far pointer<>int -- need to use large model or size_t */
#pragma warning(disable:4759) /* segment lost in conversion -- need to use large model or size_t */
#endif
#endif
...
/* min/max are a constant headache, alas, the std definitions are useful.. */
#define NOMINMAX
...
/* NT typographic conventions for non-Windows code */
typedef char CHAR;
...
/*
_MSC_VER 1000 is Visual C++ 4.0
_MSC_VER 1010 is Visual C++ 4.1
_MSC_VER 1020 is Visual C++ 4.2
_MSC_VER 1100 is Visual C++ 5.0
_MSC_VER 1200 is Visual C++ 6.0
_MSC_VER 1300 is Visual C++ 7.0
_MSC_VER 1310 is Visual C++ 7.1
_MSC_VER 1400 is Visual C++ 8.0
*/

#if (_MSC_VER >= 1000)

#if (_MSC_VER >= 1020) && (_MSC_VER < 1300)
/* yvals.h fiddles around with warnings like mad */
#include <yvals.h>
#endif
...
#pragma warning(disable:4100) /* unused parameter -- in STL */
#pragma warning(disable:4146) /* unary minus operator applied to unsigned type, result still unsigned */
#pragma warning(disable:4244) /* conversion from larger int to smaller int */
#pragma warning(disable:4511) /* copy constructor could not be generated */
#pragma warning(disable:4512) /* assignment operator could not be generated */
#pragma warning(disable:4663) /* C++ language change regarding templates */
...
#if (_MSC_VER < 1020)
/* it compiles stuff ok but does not work */
#define BASIC_STRING1(t) error Visual C++ 4.0/4.1 string does not work
#elif (_MSC_VER == 1020)
/* 4.2 -- no default parameters */
#define BASIC_STRING1(t) basic_string<t, char_traits<t>, allocator<t> >
#else
#define BASIC_STRING1(t) basic_string<t>
#endif

#if (_MSC_VER == 1000 || _MSC_VER == 1010)
/* 4.0/4.1 -- no default parameters, and only two instead of three parameters */
#define SET1(t) set<t, less<t> >
#elif (_MSC_VER == 1020)
/* 4.2 -- no default parameters */
#define SET1(t) set<t, less<t>, allocator<t> >
#else
#define SET1(t) set<t>
#endif
...
#if (_MSC_VER == 1020)
/* 4.2 -- no default parameters */
#define VECTOR1(t) vector<t, allocator<t> >
#else
